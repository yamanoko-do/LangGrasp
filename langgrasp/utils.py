...
def create_pointcloud_from_rgbd(intrinsic, color_img, depth_img, mask_img=None,
    ...
    if visualize:
        ...
        saved_intrinsic_matrix = np.array([[1170.8663459165612, 0.0, 1084.5], [0.0, 1170.8663459165612, 675.5], [0.0, 0.0, 1.0]])
        saved_extrinsic = np.array([[-0.974221076744998, 0.16810019395334194, 0.15045138224245594, -174.59217110393337], [-0.03875697031582581, -0.7817063810736564, 0.6224411868125901, -658.5369308208572], [0.22224128976802426, 0.6005642834714501, 0.7680698864951475, 279.6124631546485], [0.0, 0.0, 0.0, 1.0]])
        # -------------------------------------------------------------------------------
